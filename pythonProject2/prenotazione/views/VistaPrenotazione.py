...
class VistaPrenotazione(QWidget):
    def __init__(self, prenotazione, disdici_prenotazione, elimina_callback, parent=None):
        ...
        label_nome = QLabel(self.controller.get_attivita_prenotazione().nome)
        ...
        btn_disdici.setCursor(QCursor(QtCore.Qt.PointingHandCursor))
        btn_disdici.setStyleSheet("border: 2px solid;" +
                                  "border-radius: 11px;" +
                                  "font-size: 20px;" +
                                  "font-weight: bold;" +
                                  "color: 'black'"
        ...
        self.setWindowTitle(self.controller.get_attivita_prenotazione().nome)
